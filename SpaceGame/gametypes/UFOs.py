...
UFO_DIFFICULTY = [
    UFOGeneratorRanges(num_ufos=[1,3],
                       agression=[1,1],
                       intelligence=[1,1],
                       velocity=[-10,10],
                       angular_velocity=[-1,1]),
    UFOGeneratorRanges(num_ufos=[2,4],
                       agression=[1,1],
                       intelligence=[1,1],
                       velocity=[-10,10],
                       angular_velocity=[-1,1]),
    UFOGeneratorRanges(num_ufos=[4,6],
                       agression=[1,1],
                       intelligence=[1,1],
                       velocity=[-10,10],
                       angular_velocity=[-1,1]),
    UFOGeneratorRanges(num_ufos=[6,8],
                       agression=[1,1],
                       intelligence=[1,1],
                       velocity=[-10,10],
                       angular_velocity=[-1,1]),
    UFOGeneratorRanges(num_ufos=[8,10],
                       agression=[1,1],
                       intelligence=[1,1],
                       velocity=[-10,10],
                       angular_velocity=[-1,1]),
    UFOGeneratorRanges(num_ufos=[10,10],
                       agression=[1,1],
                       intelligence=[1,1],
                       velocity=[-10,10],
                       angular_velocity=[-1,1])
