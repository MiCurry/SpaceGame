...
StationSputnik2 = SpaceObjectData(
    spritefile=os.path.join(STATION_SPRITE_PATH, "spaceStation_016.png"),
    health=HEALTH_SMALL,
    mass=MASS_SMALL,
    friction=0.0,
    elasticity=ELASTICITY_SMALL,
...
StationSmall1 = SpaceObjectData(
    spritefile=os.path.join(STATION_SPRITE_PATH, "spaceStation_018.png"),
    health=HEALTH_SMALL,
    mass=MASS_SMALL,
    friction=0.0,
    elasticity=ELASTICITY_SMALL,
...
StationSmall2 = SpaceObjectData(
    spritefile=os.path.join(STATION_SPRITE_PATH, "spaceStation_019.png"),
    health=HEALTH_SMALL,
    mass=MASS_SMALL,
    friction=0.0,
    elasticity=ELASTICITY_SMALL,
...
StationSmall3 = SpaceObjectData(
    spritefile=os.path.join(STATION_SPRITE_PATH, "spaceStation_022.png"),
    health=HEALTH_SMALL,
    mass=MASS_SMALL,
    friction=0.0,
    elasticity=ELASTICITY_SMALL,
...
StationSmall4 = SpaceObjectData(
    spritefile=os.path.join(STATION_SPRITE_PATH, "spaceStation_023.png"),
    health=HEALTH_SMALL,
    mass=MASS_SMALL,
    friction=0.0,
    elasticity=ELASTICITY_SMALL,
...
StationBig1 = SpaceObjectData(
    spritefile=os.path.join(STATION_SPRITE_PATH, "spaceStation_020.png"),
    health=HEALTH_BIG,
    mass=MASS_BIG,
    friction=0.0,
...
StationBig2 = SpaceObjectData(
    spritefile=os.path.join(STATION_SPRITE_PATH, "spaceStation_021.png"),
    health=HEALTH_SMALL,
    mass=MASS_SMALL,
    friction=0.0,
    elasticity=ELASTICITY_BIG,
...
StationBig3 = SpaceObjectData(
    spritefile=os.path.join(STATION_SPRITE_PATH, "spaceStation_024.png"),
    health=HEALTH_SMALL,
    mass=MASS_SMALL,
    friction=0.0,
    elasticity=ELASTICITY_BIG,
